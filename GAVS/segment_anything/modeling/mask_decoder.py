...
class MaskDecoder(nn.Module):
    def __init__(
        ...
        *,
        ...
        self.aud_og_dim = 128  # 128 for VGGish
        ...
        self.audio_flat = self.aud_og_dim
    ...
    def forward(
        ...
        # Prepare output
        return masks, iou_pred  # , sparse_prompt_embeddings
    ...
    def predict_masks(
        ...
        # Run the transformer
        hs, src = self.transformer(src, pos_src, tokens)  # cross-modal transformer.
        iou_token_out = hs[:, 0, :]
